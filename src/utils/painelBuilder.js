        ...
        components: [
            {
                ...
                components: [
                    ...
                    { type: 14, divider: true, spacing: 1 },
                    {
                        type: 1, 
                        components: [
                            { type: 2, style: 2, label: "⬅️", custom_id: `painel_page_${page - 1}`, disabled: page === 1 },
                            { type: 2, style: 2, label: `Página ${page}/${totalPages}`, custom_id: "none", disabled: true },
                            { type: 2, style: 2, label: "➡️", custom_id: `painel_page_${page + 1}`, disabled: page === totalPages }
                        ]
                    },
        ...
        components: [
            {
                ...
                components: [
                    { type: 10, content: "# 📋 Central de Gestão e RH\n*Controle quem entra e quem sai.*" },
                    { type: 14, divider: true, spacing: 1 },
                    {
                        type: 9, 
                        components: [{ type: 10, content: "**🏴 Recrutamento e Peneira**\nConfigure as perguntas." }],
                        accessory: { type: 2, style: 2, label: "Configurar", custom_id: "rh_recrutamento" }
                    },
                    { type: 14, divider: true, spacing: 1 },
                    { type: 1, components: [{ type: 2, style: 4, label: "⬅️ Voltar ao QG", custom_id: "painel_page_1" }] }
                ]
            }
        ]
    };
...
module.exports = { buildPainelPayload, buildRHPainelPayload };